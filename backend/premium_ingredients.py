...
_HANDPICKED = (
    ...
    (44, "안심", ("돼지안심", "돼지고기안심")),
    (45, "등심", ("돼지등심", "돼지고기등심")),
    # `스테이크용 소고기`·`닭다리살 스테이크` 는 스테이크라는 **조리법**이지
    # 비싼 부위가 아니다. `스테이크용` 이 붙은 것은 전부 뺀다.
    (46, "스테이크", ("스테이크소스", "스테이크시즈닝", "스테이크용",
                    "두부스테이크", "함박스테이크", "떡갈비스테이크",
                    "버섯스테이크", "감바스", "닭다리살", "돼지고기")),
    (47, "양갈비", ()),
