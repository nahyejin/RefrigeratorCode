...
#
# 아래 네 짝도 같은 날 처리 — 전부 "바탕 단어가 이미 대표어/동의어 관계로
# 등록돼 있는데(소고기 행에 쇠고기, 오가피 행에 오갈피, 표고버섯 행에 표고,
# 채끝살 행에 채끝이 각각 동의어로 있다) 그 단어를 품은 복합어만 안 옮겨진"
# 같은 모양이라 확신을 갖고 합쳤다. 남기는 쪽은 그 바탕 단어의 대표어 표기.
MERGE_PAIRS = [
    ("쇠고기장조림", "소고기장조림"),
    ("오갈피나무", "오가피나무"),
    ("소고기 채끝", "소고기 채끝살"),
