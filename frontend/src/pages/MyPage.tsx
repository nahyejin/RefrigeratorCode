  ...
  return (
    <div className="bg-white min-h-screen max-w-[400px] mx-auto relative" style={{ boxSizing: 'border-box', display: 'flex', flexDirection: 'column' }}>
      ...
      {/* 개발자에게 말 거는 자리 + 방침·약관.
          ...
          어디를 봐야 할지도 분명하다. */}
      {/* 배경을 회색으로 감싸 위 카드 영역("즐겨찾기/기록/완료" 요약, 그
          ...
          */}
          ...
          >
            ...
            >
              ...
              {/* 회원탈퇴 — 취소/변경적용 버튼과는 다른 칸(꼬리가 아니라 이
                  스크롤되는 콘텐츠 영역)에 둔다. "닉네임·이메일·비밀번호·
                  크레딧이 있는 이 영역의 맨 아래, 취소/적용보다는 위" 라는
                  요청 — 자주 쓰는 저장 동작과 같은 줄에 있을 이유가 없고,
                  왼쪽 아래에 작게 있으면 충분하다. */}
              <div className="mt-5 pt-4 border-t border-gray-200 text-left">
                <button
                  type="button"
